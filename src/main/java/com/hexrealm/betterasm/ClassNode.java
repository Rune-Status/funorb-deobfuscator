...
public class ClassNode extends org.objectweb.asm.tree.ClassNode {
    ...
    public MethodNode getNoArgsConstructor() {
        ...
        if (noArgsConstructor == null) {
            noArgsConstructor = findFirstMethodMatching(methodNode -> name.equals("<init>") && Type.getArgumentTypes(methodNode.desc).length == 0);
        }
    ...
    public MethodNode getClassInitializer() {
        ...
        if (classInitializer == null) {
            classInitializer = findFirstMethodMatching(methodNode -> name.equals("<clinit>"));
        }
